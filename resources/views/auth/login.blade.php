                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('/public/img/logo.png'); background-color: #2dce89;
              background-size: cover;">
                                <span class=""></span>
                                <h1 class="mt-5 text-black font-weight-bolder position-relative">TRIPLUR.</h1><p>"TRAVEL AND TOURISM."</p>
                            </div>
                        </div>
                    </div>
                </div>
